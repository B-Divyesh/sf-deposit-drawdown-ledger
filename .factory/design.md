...
Generation: Azure AI Foundry factory image deployment via `/opt/fleet/lib/gen-image.sh`, 2026-08-28. Generated imagery is original to this product. The selected source and exact prompt live in `assets/src/hero-night-ledger.json`; the optimized WebP ships locally. Hand-authored SVG icons and PWA marks are MIT-licensed with the repository.
